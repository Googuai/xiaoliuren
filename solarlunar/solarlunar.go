...
func GetCalculateLunar() func(string) (lunarYear, lunarMonth, lunarDay, leapMonth int, leapMonthFlag bool) {
	return calculateLunar
}
...
func CalculateTime(hour string) (lunarH int) {
